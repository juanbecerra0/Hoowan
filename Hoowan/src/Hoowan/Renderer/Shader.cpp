...
namespace Hoowan {
	...
	Hoowan::Ref<Hoowan::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Hoowan::Ref<Hoowan::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Hoowan::Ref<Hoowan::Shader> ShaderLibrary::Get(const std::string& name)
	{
